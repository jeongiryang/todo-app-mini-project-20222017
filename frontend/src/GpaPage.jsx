...
function GpaPage() {
  // 로컬 스토리지에서 데이터 불러오기 (보안을 위해 DB 대신 로컬 저장)
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 flex flex-col min-h-screen relative">
      <style>{`
        ...
        @keyframes firework { 0% { transform: scale(0) rotate(0deg); opacity: 1; } 100% { transform: scale(2) rotate(45deg); opacity: 0; } }
        .golden-firework { position: absolute; animation: firework 1.5s ease-out forwards; z-index: 9999; font-size: 4rem; }
      `}</style>
      ...
      {/* 투어 포커싱 효과용 useEffect (GpaPage 전용) */}
      ...
      <div className="flex-grow">
        <div id="tour-header" className="text-center mb-8 relative">
          ...
          <h2 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500 mb-3 tracking-tighter drop-shadow-sm flex justify-center items-center">
            CWNU GPA <span className="inline-block ml-3 py-1 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600 italic text-4xl">V5_super_2.5</span>
          </h2>
